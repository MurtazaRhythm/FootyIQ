...
export default function NeuralBackground({
  ...
  useEffect(() => {
    ...
    // Listen on window, not the container: content layered above the canvas
    // (header, chat, input bar) would otherwise swallow mouse events and
    // the particles would never react to the cursor.
